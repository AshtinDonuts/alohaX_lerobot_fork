...
Example of usage:
```bash
python lerobot/scripts/move_to_rest_position.py --robot-path lerobot/configs/robot/aloha_solo.yaml --pose-file .cache/poses/rest_pose.json
```
...
You can also specify which arms to move:
```bash
python lerobot/scripts/move_to_rest_position.py --arms left_follower right_follower
```
"""
